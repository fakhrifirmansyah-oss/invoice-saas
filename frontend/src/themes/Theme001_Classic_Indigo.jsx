...
export default function Theme001_Classic_Indigo({ invoice }) {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-12 bg-white border-2 border-gray-900 font-sans text-sm relative overflow-hidden">
      ...
      <div className="mb-10 bg-indigo-50 border border-indigo-200 p-4 rounded text-center">
         <p className="font-bold text-indigo-800">Terbilang (Say in Words):</p>
         <p className="text-lg font-black uppercase text-indigo-900 border-b-2 border-indigo-900 inline-block pb-1">
