...
export default function Theme014_Classic_Amber({ invoice }) {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-12 bg-white border-2 border-gray-900">
      ...
      <div className="flex justify-end"><h3 className="text-2xl font-bold bg-amber-100 p-4 border-2 border-gray-900">TOTAL: ${invoice.total}</h3></div>
    </div>
  );
}