...
export default function Theme020_Classic_Orange({ invoice }) {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-12 bg-white border-2 border-gray-900">
      ...
      <div className="flex justify-end"><h3 className="text-2xl font-bold bg-orange-100 p-4 border-2 border-gray-900">TOTAL: ${invoice.total}</h3></div>
    </div>
  );
}