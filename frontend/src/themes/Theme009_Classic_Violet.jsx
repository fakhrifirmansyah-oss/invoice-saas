...
export default function Theme009_Classic_Violet({ invoice }) {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-12 bg-white border-2 border-gray-900 font-sans text-sm relative overflow-hidden">
      ...
      <div className="mb-10 bg-violet-50 border border-violet-200 p-4 rounded text-center">
         <p className="font-bold text-violet-800">Terbilang (Say in Words):</p>
         <p className="text-lg font-black uppercase text-violet-900 border-b-2 border-violet-900 inline-block pb-1">
