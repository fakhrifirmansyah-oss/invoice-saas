...
export default function Theme071_Tech_Monospace_Indigo({ invoice }) {
  if (!invoice || !invoice.items) return null;
  return (
    
    <div className="max-w-4xl mx-auto p-8 bg-black text-indigo-500 font-mono border-2 border-indigo-500 rounded">
      ...
      <div className="mb-8 p-4 bg-indigo-900/30">
        <p>> TARGET_ENTITY: {invoice.client_name}</p>
        <p>> PAYLOAD_VALUE: ${invoice.total}</p>
      </div>
      <table className="w-full text-left">
        <thead><tr className="border-b border-indigo-500"><th>EXEC_ID</th><th>OP_DESC</th><th>VAL</th></tr></thead>
        <tbody>
