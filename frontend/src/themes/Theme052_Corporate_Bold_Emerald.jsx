...
export default function Theme052_Corporate_Bold_Emerald({ invoice }) {
  if (!invoice || !invoice.items) return null;
  return (
    
    <div className="max-w-5xl mx-auto bg-white border-t-[20px] border-emerald-700 shadow-2xl">
      <div className="p-12 flex justify-between bg-gray-50">
        ...
        <div className="text-right">
          <p className="text-2xl font-bold text-emerald-700">FDBAtech Inc.</p>
      ...
      <div className="p-12">
        ...
        <div className="mt-8 flex justify-end"><div className="w-1/3 bg-emerald-50 p-6 rounded text-right"><p className="text-sm">BALANCE DUE</p><p className="text-4xl font-black text-emerald-700">${invoice.total}</p></div></div>
      </div>
    </div>
  );
}