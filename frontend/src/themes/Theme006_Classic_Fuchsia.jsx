...
export default function Theme006_Classic_Fuchsia({ invoice }) {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-12 bg-white border-2 border-gray-900 font-sans text-sm relative overflow-hidden">
      ...
      <div className="mb-10 bg-fuchsia-50 border border-fuchsia-200 p-4 rounded text-center">
         <p className="font-bold text-fuchsia-800">Terbilang (Say in Words):</p>
         <p className="text-lg font-black uppercase text-fuchsia-900 border-b-2 border-fuchsia-900 inline-block pb-1">
